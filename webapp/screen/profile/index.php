<!-- Created by Manfred MOUKATE on 13/04/2024 01:06, -->
<!-- Email moukatemanfred@gmail.com -->
<!-- Copyright (c) 2024. All rights reserved. -->
<!-- Last modified 13/04/2024 01:06 -->
<?php
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-white py-0 shadow-sm">
    <div class="container-fluid">
        <div class="w-100 d-flex align-items-center justify-content-between p-2 text-black">
            ...
            <a class="lead-1 text-decoration-none font-bold-primary text-black-50 lh-1 mb-0"><strong> Gestion des profiles</strong></a>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-header bg-white">
                                <div class="d-flex flex-row align-items-center mb-0 py-1"><a href="#"
                                    ...
                                    <div class="p-0 font-regular text-black-50 lead-1_2 ms-2  ">Gestion des profils
                                    </div>
                                </div>
                            </div>
                            <div class="card-body border-bottom" style="height: 380px">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1"
                                                   class="form-label p-0 font-regular text-black-50 lead-1_2 ms-2">Nom du profil
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1"
                                                   class="form-label p-0 font-regular text-black-50 lead-1_2 ms-2">Resume </label>
                                ...
                                <div class="row ">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1"
                                                   class="form-label p-0 font-regular text-black-50 lead-1_2 ms-2">Parent
                                                <span style="color: red">*</span> </label>
                        ...
                        <div class="card shadow-sm">
                            <div class="card-header bg-white">
                                <div class="d-flex flex-row align-items-center mb-0 py-1"><a href="#"
                                    ...
                                    <div class="p-0 font-regular text-black-50 lead-1_2 ms-2  ">Liste des profils</div>
                                </div>
                            </div>
                            <div class="card-body border-bottom" style="height: 380px">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <table class="table">
                                           ...
                                           echo' <tr>
                                                <td> <a style="color: #0b2e13" href="" >' .$profiles->getName() .' </a></td>
                                                <td>' . $profiles->getResume() . ' </td>
                                            </tr>';
                                            }
                                            ?>
                                            </tbody>
