...
try {
    Criteria::_formRequiredCheck([TOKEN, TITLE, OBJCTV, COMMENT, PARTCPNT, DATETIME,CITY, STATUT ], $_POST);
    $date = new DateTime($_POST[DATETIME]);

// Convertit la date en une chaîne dans le format Y-m-d H:i:s 
    ...
    if(isset($_POST[TOKEN]) && $_POST[TOKEN] !== 'null' && $_POST[TOKEN] !== '' ){
        ...
        $project->setLaunch($_POST[DATETIME]);
